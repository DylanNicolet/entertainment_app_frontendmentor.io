<template>
    <section class="item-card">
        <img :src="itemProp.item.thumbnail.regular.small" :alt="itemProp.item.title" class="item-card__image">

        <button :class="'item-card__bookmark-btn ' + bookmarkedStyling" @click="addBookmark()">
